...
if (runLoop) {
  ...
  ## save(efficiencyGain, file=here::here("nimbleNoBounds/data/efficiencyGain.rda"))
}
```
...
3. computational overhead arising from the transformations is negligible compared to potential efficiency gain from sampling on the unbounded real line.
